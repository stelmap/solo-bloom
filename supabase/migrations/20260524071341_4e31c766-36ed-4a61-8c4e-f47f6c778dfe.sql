-- Prevent double-booking: treat pending & needs_linking requests as occupied with full duration overlap (incl. buffer)
...
-- Update create-booking to use range overlap for pending blocking too
