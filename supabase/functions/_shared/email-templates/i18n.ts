/**
 * Shared translations for ALL Solo .Bizz outgoing emails (auth + transactional).
 *
...
const en: LangStrings = {
  ...
  recovery: {
    ...
    ctaFallback: 'Open Solo .Bizz',
  },
  invite: {
    preview: "You've been invited to Solo .Bizz",
    tagline: TAGLINE,
    heroTitle: "You've been invited",
    heroSub: 'Join your team in Solo .Bizz.',
  ...
  footer: {
    brandLine: '© Solo .Bizz · solo-bizz.com',
...
const uk: LangStrings = {
  ...
  recovery: {
    ...
    ctaFallback: 'Відкрити Solo .Bizz',
  },
  invite: {
    preview: 'Вас запросили до Solo .Bizz',
    tagline: TAGLINE,
    heroTitle: 'Вас запросили',
    heroSub: 'Приєднуйтесь до команди в Solo .Bizz.',
...
const ru: LangStrings = {
  signup: {
    preview: 'Подтвердите почту — один шаг до вашей практики',
    tagline: TAGLINE,
    heroTitle: 'Подтвердите свою почту',
    heroSub: 'Один шаг — и ваша практика в ваших руках.',
    greeting: 'Здравствуйте 👋',
    intro: (siteName) => `Спасибо за регистрацию в ${siteName}. Пожалуйста, подтвердите свой адрес электронной почты, чтобы активировать аккаунт.`,
    signingInAs: 'Вход выполнен как',
    cta: 'Подтвердить почту',
    ignore: 'Если вы не создавали аккаунт, просто проигнорируйте это письмо.',
    features: {
      calendar: 'Умный календарь', calendarDesc: 'Сессии, записи и напоминания',
      finance: 'Финансовый учёт', financeDesc: 'Доход и маржа с одного взгляда',
      metrics: 'Метрики практики', metricsDesc: 'Решения на основе данных',
    },
  },
  magicLink: {
    preview: 'Ваша ссылка для входа готова',
    tagline: TAGLINE,
    heroTitle: 'Ваша ссылка для входа',
    heroSub: 'Один клик — и вы снова в своей практике.',
    body: (siteName) => `Нажмите кнопку ниже, чтобы войти в ${siteName}. Срок действия ссылки скоро истечёт.`,
    cta: 'Войти',
    ignore: 'Если вы не запрашивали эту ссылку, просто проигнорируйте это письмо.',
  },
  recovery: {
    preview: 'Сбросьте свой пароль',
    tagline: TAGLINE,
    heroTitle: 'Сбросьте свой пароль',
    heroSub: 'Введите код ниже в приложении, чтобы продолжить.',
    intro: 'Мы получили запрос на сброс вашего пароля. Введите код ниже в приложении, чтобы продолжить.',
    helper: 'Этот код одноразовый и скоро станет недействительным. Если вы не запрашивали сброс пароля, просто проигнорируйте это письмо — ваш пароль не изменится.',
    ctaFallback: 'Открыть Solo .Bizz',
  },
  invite: {
    preview: 'Вас пригласили в Solo .Bizz',
    tagline: TAGLINE,
    heroTitle: 'Вас пригласили',
    heroSub: 'Присоединяйтесь к команде в Solo .Bizz.',
    body: (siteName) => `Вас пригласили присоединиться к ${siteName}. Нажмите кнопку ниже, чтобы принять приглашение и создать аккаунт.`,
    cta: 'Принять приглашение',
    ignore: 'Если вы не ожидали это приглашение, просто проигнорируйте письмо.',
  },
  emailChange: {
    preview: 'Подтвердите смену электронной почты',
    tagline: TAGLINE,
    heroTitle: 'Подтвердите смену почты',
    heroSub: 'Быстрое подтверждение защищает ваш аккаунт.',
    body: (email, newEmail) => `Вы запросили смену адреса электронной почты с ${email} на ${newEmail}.`,
    confirmIntro: 'Нажмите кнопку ниже, чтобы подтвердить это изменение:',
    cta: 'Подтвердить изменение',
    warning: 'Если вы не запрашивали это изменение, немедленно защитите свой аккаунт.',
  },
  reauthentication: {
    preview: 'Ваш код подтверждения',
    tagline: TAGLINE,
    heroTitle: 'Подтвердите свою личность',
    heroSub: 'Используйте код ниже, чтобы подтвердить, что это вы.',
    intro: 'Используйте код ниже, чтобы подтвердить, что это вы:',
    footer: 'Срок действия кода скоро истечёт. Если вы этого не запрашивали, просто проигнорируйте письмо.',
  },
  footer: {
    brandLine: '© Solo .Bizz · solo-bizz.com',
    ignoreNote: 'Если вы не создавали аккаунт, просто проигнорируйте это письмо.',
    contact: 'info@solo-bizz.com',
  },
  subjects: {
    signup: 'Подтвердите свою почту',
    invite: 'Вас пригласили',
    magiclink: 'Ваша ссылка для входа',
    recovery: 'Сбросьте свой пароль',
    email_change: 'Подтвердите новый адрес почты',
...
const pl: LangStrings = {
  ...
  recovery: {
    ...
    ctaFallback: 'Otwórz Solo .Bizz',
  },
  invite: {
    preview: 'Zostałeś zaproszony do Solo .Bizz',
    tagline: TAGLINE,
    heroTitle: 'Zostałeś zaproszony',
    heroSub: 'Dołącz do zespołu w Solo .Bizz.',
...
const fr: LangStrings = {
  ...
  recovery: {
    ...
    ctaFallback: 'Ouvrir Solo .Bizz',
  },
  invite: {
    preview: 'Vous avez été invité·e sur Solo .Bizz',
    tagline: TAGLINE,
    heroTitle: 'Vous avez été invité·e',
    heroSub: 'Rejoignez votre équipe sur Solo .Bizz.',
  ...
  subjects: {
    ...
    invite: 'Vous avez été invité·e sur Solo .Bizz',
    magiclink: 'Votre lien de connexion Solo .Bizz',
    recovery: 'Réinitialisez votre mot de passe Solo .Bizz',
