...
export function useUpdateProfile() {
  ...
  return useMutation({
    ...
    mutationFn: async (updates: { full_name?: string; business_name?: string; phone?: string; language?: string; reminder_minutes?: number; work_hours_start?: string; work_hours_end?: string; time_format?: string; default_duration?: number; currency?: string; business_id?: string; tax_id_type?: string; business_address?: string; vat_mode?: string; vat_rate?: number; onboarding_completed?: boolean; income_recognition_method?: string; avatar_url?: string | null; show_practice_profile_on_booking?: boolean; public_email?: string | null }) => {
