...
export const SUPPORT_UA_COPY = {
  campaignName: {
    en: "Support Ukrainian Sole Practitioners",
    uk: "Підтримка українських приватних фахівців",
    pl: "Wsparcie ukraińskich specjalistów prowadzących własną praktykę",
    fr: "Soutien aux indépendants ukrainiens",
    ru: "Поддержка украинских частных специалистов",
  },
  bannerEyebrow: {
    en: "SUPPORT UKRAINIAN SOLE PRACTITIONERS",
    uk: "ПІДТРИМКА УКРАЇНСЬКИХ ПРИВАТНИХ ФАХІВЦІВ",
    pl: "WSPARCIE UKRAIŃSKICH SPECJALISTÓW",
    fr: "SOUTIEN AUX INDÉPENDANTS UKRAINIENS",
    ru: "ПОДДЕРЖКА УКРАИНСКИХ ЧАСТНЫХ СПЕЦИАЛИСТОВ",
  },
  bannerTitle: {
  ...
  bannerDiscount: {
    en: "Sole practitioners connected with Ukraine can receive 50% off Solo Practice and Pro Practice.",
    uk: "Для приватних фахівців з України діє знижка 50% на Solo Practice та Pro Practice.",
    pl: "Specjaliści prowadzący własną praktykę związani z Ukrainą otrzymują 50% zniżki na Solo Practice i Pro Practice.",
    fr: "Les indépendants liés à l'Ukraine bénéficient de 50 % de réduction sur Solo Practice et Pro Practice.",
    ru: "Для частных специалистов из Украины действует скидка 50% на Solo Practice и Pro Practice.",
  },
  bannerCtaPrimary: {
    en: "Get 50% off",
  ...
  bannerSubline: {
    en: "Support Ukraine Sole Practitioners · Special offer for Ukrainian professionals",
    uk: "Support Ukraine Sole Practitioners · Спеціальна пропозиція для українських фахівців",
    pl: "Support Ukraine Sole Practitioners · Oferta specjalna dla ukraińskich specjalistów",
    fr: "Support Ukraine Sole Practitioners · Offre spéciale pour les professionnels ukrainiens",
    ru: "Support Ukraine Sole Practitioners · Специальное предложение для украинских специалистов",
  },
  bannerImageAlt: {
  ...
  cardCampaignLabel: {
    en: "Support Ukraine Sole Practitioners",
    uk: "Support Ukraine Sole Practitioners",
    pl: "Support Ukraine Sole Practitioners",
    fr: "Support Ukraine Sole Practitioners",
    ru: "Support Ukraine Sole Practitioners",
  },
  cardCampaignNote: {
    en: "50% support discount for Ukrainian sole practitioners.",
    uk: "Знижка 50% на підтримку українських приватних фахівців.",
    pl: "50% zniżki wspierającej ukraińskich specjalistów prowadzących własną praktykę.",
    fr: "Remise de soutien de 50 % pour les indépendants ukrainiens.",
    ru: "Скидка 50% в поддержку украинских частных специалистов.",
  },
  badgeCampaign: {
