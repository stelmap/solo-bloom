...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for the signed-in SoloBizz user. Use these to look up clients, upcoming or past appointments, income/expense totals, and to create new client records. All data is scoped to the authenticated user.",
