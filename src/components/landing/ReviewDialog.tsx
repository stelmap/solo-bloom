...
const COPY: Record<string, Copy> = {
  uk: {
    title: "Поділіться своїм досвідом із Solo .Bizz",
    intro: "Ваш відгук допоможе іншим фахівцям краще зрозуміти, як Solo .Bizz може підтримати їхню практику. Перед публікацією відгук буде перевірено.",
    ratingLabel: "Як ви оцінюєте роботу Solo .Bizz?",
    planLabel: "Яким тарифом Solo .Bizz ви користуєтеся?",
    plans: [
    ...
    bodyPlaceholder: "Розкажіть, як Solo .Bizz допомагає вам у роботі та що вам подобається найбільше.",
    bodyHint: "від 30 до 1000 символів",
    nameLabel: "Ім’я, яке буде показане у відгуку",
    namePlaceholder: "Олена Л.",
    emailLabel: "Електронна пошта вашого акаунта Solo .Bizz",
    emailHint: "Email потрібен лише для підтвердження, що ви користуєтеся Solo .Bizz. Він не буде опублікований.",
    consent: "Я погоджуюся на публікацію мого імені, професії, оцінки та тексту відгуку на сайті Solo .Bizz.",
  ...
  en: {
    title: "Share your experience with Solo .Bizz",
    intro: "Your review helps other professionals understand how Solo .Bizz can support their practice. Every review is checked before publication.",
    ratingLabel: "How would you rate Solo .Bizz?",
    planLabel: "Which Solo .Bizz plan do you use?",
    plans: [
      { value: "free_starter", label: "Free Starter" },
      { value: "solo_practice", label: "Solo Practice" },
      { value: "pro_practice", label: "Pro Practice" },
    ...
    bodyPlaceholder: "Tell us how Solo .Bizz helps you at work and what you like most.",
    bodyHint: "between 30 and 1000 characters",
    nameLabel: "Name shown with the review",
    namePlaceholder: "Olena L.",
    emailLabel: "Email of your Solo .Bizz account",
    emailHint: "The email is only used to confirm you are a Solo .Bizz user. It will not be published.",
    consent: "I agree to publish my name, profession, rating and review text on the Solo .Bizz site.",
    submit: "Send review",
  ...
  pl: {
    title: "Podziel się swoim doświadczeniem z Solo .Bizz",
    intro: "Twoja opinia pomoże innym specjalistom zrozumieć, jak Solo .Bizz może wesprzeć ich praktykę. Przed publikacją opinia jest weryfikowana.",
    ratingLabel: "Jak oceniasz Solo .Bizz?",
    planLabel: "Z jakiego planu Solo .Bizz korzystasz?",
    plans: [
      { value: "free_starter", label: "Free Starter" },
      { value: "solo_practice", label: "Solo Practice" },
      { value: "pro_practice", label: "Pro Practice" },
    ...
    bodyPlaceholder: "Napisz, jak Solo .Bizz pomaga Ci w pracy i co podoba Ci się najbardziej.",
    bodyHint: "od 30 do 1000 znaków",
    nameLabel: "Imię widoczne przy opinii",
    namePlaceholder: "Olena L.",
    emailLabel: "E-mail Twojego konta Solo .Bizz",
    emailHint: "E-mail służy wyłącznie do potwierdzenia, że korzystasz z Solo .Bizz. Nie zostanie opublikowany.",
    consent: "Zgadzam się na publikację mojego imienia, zawodu, oceny i treści opinii na stronie Solo .Bizz.",
  ...
  fr: {
    title: "Partagez votre expérience avec Solo .Bizz",
    intro: "Votre avis aide d'autres professionnels à comprendre comment Solo .Bizz peut soutenir leur activité. Chaque avis est vérifié avant publication.",
    ratingLabel: "Comment évaluez-vous Solo .Bizz ?",
    planLabel: "Quelle formule Solo .Bizz utilisez-vous ?",
    plans: [
      { value: "free_starter", label: "Free Starter" },
      { value: "solo_practice", label: "Solo Practice" },
      { value: "pro_practice", label: "Pro Practice" },
    ...
    bodyPlaceholder: "Racontez comment Solo .Bizz vous aide au quotidien et ce que vous appréciez le plus.",
    bodyHint: "entre 30 et 1000 caractères",
    nameLabel: "Nom affiché avec l'avis",
    namePlaceholder: "Olena L.",
    emailLabel: "E-mail de votre compte Solo .Bizz",
    emailHint: "L'e-mail sert uniquement à confirmer que vous utilisez Solo .Bizz. Il ne sera pas publié.",
    consent: "J'accepte la publication de mon nom, de mon métier, de ma note et de mon avis sur le site Solo .Bizz.",
  ...
  ru: {
    title: "Поделитесь своим опытом с Solo .Bizz",
    intro: "Ваш отзыв поможет другим специалистам понять, как Solo .Bizz может поддержать их практику. Перед публикацией отзыв проверяется.",
    ratingLabel: "Как вы оцениваете работу Solo .Bizz?",
    planLabel: "Каким тарифом Solo .Bizz вы пользуетесь?",
    plans: [
      { value: "free_starter", label: "Free Starter" },
      { value: "solo_practice", label: "Solo Practice" },
      { value: "pro_practice", label: "Pro Practice" },
    ...
    bodyLabel: "Ваш отзыв",
    bodyPlaceholder: "Расскажите, как Solo .Bizz помогает вам в работе и что нравится больше всего.",
    bodyHint: "от 30 до 1000 символов",
    nameLabel: "Имя, которое будет показано в отзыве",
    namePlaceholder: "Елена Л.",
    emailLabel: "Электронная почта вашего аккаунта Solo .Bizz",
    emailHint: "Email нужен только для подтверждения, что вы пользуетесь Solo .Bizz. Он не будет опубликован.",
    consent: "Я согласен(на) на публикацию моего имени, профессии, оценки и текста отзыва на сайте Solo .Bizz.",
