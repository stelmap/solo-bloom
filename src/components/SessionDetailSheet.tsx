      ...
      const { error } = await supabase.functions.invoke("send-transactional-email", {
        body: {
          ...
          templateData: {
            ...
            confirmationUrl: clientRequiresConfirmation && apt.confirmation_status !== "confirmed"
              ? undefined  // Will be generated by the send-session-reminders function if needed
              : undefined,
          },
        },
      });
