    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="bg-card rounded-xl border border-border overflow-hidden animate-fade-in flex flex-col" style={{ maxHeight: "calc(100vh - 280px)" }}>
          <div className="grid grid-cols-[72px_repeat(7,1fr)] border-b border-border shrink-0 overflow-y-scroll [&::-webkit-scrollbar]:w-[var(--scrollbar-width,0px)]" style={{ scrollbarGutter: "stable" }}>
            <div className="p-3" />
            {days.map((day, i) => {
