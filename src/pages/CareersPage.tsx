...
const COPY = {
  uk: {
    ...
    note: "Якщо хочете долучитися до команди SoloBizz у майбутньому — напишіть нам, і ми збережемо ваше резюме.",
  },
  en: {
    back: "Home",
    title: "Careers",
    empty: "No vacancy open for now.",
    note: "If you'd like to join the SoloBizz team in the future — drop us a line and we'll keep your CV on file.",
  },
  fr: {
    back: "Accueil",
    title: "Carrières",
    empty: "Aucun poste ouvert pour le moment.",
    note: "Si vous souhaitez rejoindre l'équipe SoloBizz à l'avenir — écrivez-nous et nous garderons votre CV.",
  },
  pl: {
    back: "Strona główna",
    title: "Kariera",
    empty: "Obecnie nie mamy otwartych wakatów.",
    note: "Jeśli chcesz w przyszłości dołączyć do zespołu SoloBizz — napisz do nas, zachowamy Twoje CV.",
  },
} as const;
...
export default function CareersPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SeoHead
        path="/careers"
        title="Careers — SoloBizz"
        description="Open roles at SoloBizz. We're a small team building calm, focused tools for psychologists, therapists, coaches and tutors running solo practices."
      />
      <header className="border-b border-border px-4 sm:px-6 h-16 flex items-center">
        <div className="max-w-5xl mx-auto w-full flex items-center justify-between">
          <Link to="/" className="text-lg font-bold text-foreground">SoloBizz</Link>
