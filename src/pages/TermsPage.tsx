...
const CONTENT: Record<Language, TermsContent> = {
  en: {
    ...
    sections: [
      { h: "1. Acceptance of Terms", body: ["By creating an account or using Solo .Bizz, you agree to these Terms & Conditions. If you do not agree to these Terms, please do not use the service."] },
      { h: "2. Description of Service", body: [
        "Solo .Bizz is a cloud-based business management tool for solo professionals and small private practices, including psychologists, therapists, coaches, tutors, and similar service providers.",
        "Solo .Bizz provides functionality for client management, session scheduling, payment tracking, income and expense tracking, financial insights, and practice organization.",
        "Solo .Bizz is intended to support business administration and practice management. Financial insights provided by Solo .Bizz are for informational purposes only and should not be considered legal, tax, accounting, or financial advice.",
      ] },
      { h: "3. Free Starter Plan", body: [
        "Solo .Bizz offers a permanent free plan called Free Starter.",
        "Free Starter is not a time-limited free trial. It does not expire after a fixed number of days.",
        "Users may use Solo .Bizz free of charge while they have up to 5 active clients.",
        "An active client means a client record that is not archived. Archived clients do not count toward the active client limit.",
        "If a Free Starter user attempts to create or reactivate a client and this would exceed the limit of 5 active clients, Solo .Bizz may require the user to upgrade to a paid subscription plan before adding or reactivating that client.",
      ] },
      { h: "4. Subscription Plans & Billing", body: [
        "Solo .Bizz offers the following plans:",
        "**Free Starter**",
        ...
        "The Solo Practice monthly price is: €5 per month.",
        "Solo Practice may also be offered with discounted billing cycles: €12 per quarter (quarterly billing) or €36 per year (yearly billing).",
        ...
        "The Pro Practice monthly price is: €19 per month.",
        "Pro Practice may also be offered with discounted billing cycles: €45.60 per quarter (quarterly billing) or €136.80 per year (yearly billing).",
      ...
      { h: "5. Plan Limits and Upgrade Requirements", body: [
        "Solo .Bizz plans are differentiated by the number of active clients available under each plan.",
        ...
        "If a user reaches the active client limit of their current plan, Solo .Bizz may restrict the creation or reactivation of additional active clients until the user upgrades to a suitable plan or reduces the number of active clients by archiving existing clients.",
      ...
      { h: "6. Payment Method and Auto-Renewal", body: [
        ...
        "By subscribing to a paid plan, you authorize Solo .Bizz or its payment provider to charge the applicable subscription fee according to the selected billing cycle.",
      ] },
      { h: "7. Failed Payments", body: [
        "If a payment fails, we or our payment provider may attempt to charge the payment method again.",
        "If payment is not successfully completed after multiple attempts, Solo .Bizz may suspend or limit access to paid plan capacity until the payment issue is resolved.",
      ...
      { h: "10. Your Data", body: [
        "You retain ownership of the data you enter into Solo .Bizz.",
        "Solo .Bizz does not sell your data.",
        "We may process your data as necessary to provide, maintain, secure, and improve the service. Some data may be processed by trusted service providers that support the operation of Solo .Bizz, such as hosting, analytics, communication, or payment processing providers.",
        "Your use of Solo .Bizz may also be subject to our Privacy Policy.",
      ...
      { h: "11. Acceptable Use", body: [
        "You agree to use Solo .Bizz only for lawful professional and business purposes.",
        "You must not:",
        [
          "attempt to access another user's data;",
          "interfere with the security or operation of the service;",
          "reverse-engineer, copy, or misuse the platform;",
          "use Solo .Bizz for illegal, harmful, or unauthorized activities;",
      ...
      { h: "12. Service Availability", body: [
        ...
        "Solo .Bizz may perform maintenance, updates, or improvements from time to time. Where reasonable, we may provide notice of planned maintenance.",
        "Solo .Bizz is not liable for losses resulting from temporary service interruptions, technical issues, or third-party provider outages.",
      ] },
      { h: "13. Limitation of Liability", body: [
        "Solo .Bizz is provided on an \"as is\" and \"as available\" basis.",
        "To the maximum extent permitted by applicable law, Solo .Bizz is not liable for indirect, incidental, special, consequential, or punitive damages arising from the use of the service.",
        "Our total liability for any claim related to the service is limited to the amount you paid to Solo .Bizz during the 12 months preceding the event that gave rise to the claim.",
      ...
      { h: "14. Changes to Plans, Prices, and Terms", body: [
        "Solo .Bizz may update subscription plans, prices, client limits, billing options, or these Terms from time to time.",
        ...
        "Continued use of Solo .Bizz after changes become effective constitutes acceptance of the updated Terms.",
      ] },
      { h: "15. Contact", body: [
  ...
  fr: {
    ...
    sections: [
      { h: "1. Acceptation des conditions", body: ["En créant un compte ou en utilisant Solo .Bizz, vous acceptez les présentes Conditions générales. Si vous n'acceptez pas ces Conditions, veuillez ne pas utiliser le service."] },
      { h: "2. Description du service", body: [
        "Solo .Bizz est un outil de gestion d'activité basé sur le cloud, destiné aux professionnels indépendants et aux petites pratiques privées, notamment psychologues, thérapeutes, coachs, tuteurs et prestataires de services similaires.",
        "Solo .Bizz offre des fonctionnalités de gestion des clients, de planification des séances, de suivi des paiements, de suivi des revenus et dépenses, d'analyses financières et d'organisation de la pratique.",
        "Solo .Bizz est conçu pour faciliter l'administration et la gestion d'une activité. Les analyses financières fournies par Solo .Bizz sont à titre informatif uniquement et ne constituent pas un conseil juridique, fiscal, comptable ou financier.",
      ] },
      { h: "3. Plan Free Starter", body: [
        "Solo .Bizz propose un plan gratuit permanent appelé Free Starter.",
        "Free Starter n'est pas un essai gratuit limité dans le temps. Il n'expire pas après un nombre de jours fixé.",
        "Les utilisateurs peuvent utiliser Solo .Bizz gratuitement tant qu'ils ont jusqu'à 5 clients actifs.",
        ...
        "Si un utilisateur Free Starter tente de créer ou de réactiver un client et que cela dépasserait la limite de 5 clients actifs, Solo .Bizz peut exiger qu'il passe à un abonnement payant avant d'ajouter ou de réactiver ce client.",
      ] },
      { h: "4. Plans d'abonnement et facturation", body: [
        "Solo .Bizz propose les plans suivants :",
        "**Free Starter**",
        ...
        "Le tarif mensuel de Solo Practice est de 5 € par mois.",
        "Solo Practice peut aussi être facturé : 12 € par trimestre (facturation trimestrielle) ou 36 € par an (facturation annuelle).",
        ...
        "Le tarif mensuel de Pro Practice est de 19 € par mois.",
        "Pro Practice peut aussi être facturé : 45,60 € par trimestre ou 136,80 € par an.",
      ...
      { h: "5. Limites de plan et conditions de mise à niveau", body: [
        "Les plans Solo .Bizz se distinguent par le nombre de clients actifs disponibles.",
        ...
        "Si un utilisateur atteint la limite de son plan, Solo .Bizz peut restreindre la création ou la réactivation de clients supplémentaires jusqu'à la mise à niveau vers un plan adapté ou la réduction du nombre de clients actifs par archivage.",
      ...
      { h: "6. Mode de paiement et renouvellement automatique", body: [
        ...
        "En souscrivant à un plan payant, vous autorisez Solo .Bizz ou son prestataire de paiement à débiter le montant correspondant selon le cycle choisi.",
      ] },
      { h: "7. Échecs de paiement", body: [
        ...
        "Si le paiement n'aboutit pas après plusieurs tentatives, Solo .Bizz peut suspendre ou limiter l'accès aux fonctionnalités du plan payant jusqu'à résolution du problème.",
      ...
      { h: "10. Vos données", body: [
        "Vous conservez la propriété des données saisies dans Solo .Bizz.",
        "Solo .Bizz ne vend pas vos données.",
        ...
        "Votre utilisation de Solo .Bizz est également soumise à notre Politique de confidentialité.",
      ...
      { h: "11. Utilisation acceptable", body: [
        "Vous vous engagez à utiliser Solo .Bizz uniquement à des fins professionnelles et licites.",
        "Vous ne devez pas :",
        [
          ...
          "utiliser Solo .Bizz pour des activités illégales, nuisibles ou non autorisées ;",
      ...
      { h: "12. Disponibilité du service", body: [
        ...
        "Solo .Bizz peut effectuer des opérations de maintenance, mises à jour ou améliorations. Lorsque cela est raisonnable, nous pouvons informer des opérations planifiées.",
        "Solo .Bizz n'est pas responsable des pertes liées à des interruptions temporaires, problèmes techniques ou pannes de prestataires tiers.",
      ] },
      { h: "13. Limitation de responsabilité", body: [
        "Solo .Bizz est fourni « en l'état » et « selon disponibilité ».",
        "Dans la mesure maximale permise par la loi applicable, Solo .Bizz n'est pas responsable des dommages indirects, accessoires, spéciaux, consécutifs ou punitifs découlant de l'utilisation du service.",
        "Notre responsabilité totale pour toute réclamation est limitée au montant que vous avez payé à Solo .Bizz au cours des 12 mois précédant l'événement ayant donné lieu à la réclamation.",
      ...
      { h: "14. Modifications des plans, des prix et des conditions", body: [
        "Solo .Bizz peut mettre à jour les plans, les prix, les limites de clients, les options de facturation ou ces Conditions de temps à autre.",
        ...
        "L'utilisation continue de Solo .Bizz après l'entrée en vigueur des modifications vaut acceptation des Conditions mises à jour.",
      ] },
      { h: "15. Contact", body: [
  ...
  pl: {
    ...
    sections: [
      { h: "1. Akceptacja warunków", body: ["Tworząc konto lub korzystając z Solo .Bizz, akceptujesz niniejszy Regulamin. Jeśli nie akceptujesz tych warunków, nie korzystaj z serwisu."] },
      { h: "2. Opis usługi", body: [
        "Solo .Bizz to narzędzie do zarządzania działalnością w chmurze, przeznaczone dla samodzielnych specjalistów i małych prywatnych praktyk: psychologów, terapeutów, coachów, korepetytorów i podobnych usługodawców.",
        "Solo .Bizz oferuje funkcje zarządzania klientami, planowania sesji, śledzenia płatności, przychodów i wydatków, analiz finansowych oraz organizacji praktyki.",
        "Solo .Bizz wspiera administrację i zarządzanie praktyką. Analizy finansowe mają charakter wyłącznie informacyjny i nie stanowią porady prawnej, podatkowej, księgowej ani finansowej.",
      ] },
      { h: "3. Plan Free Starter", body: [
        "Solo .Bizz oferuje stały bezpłatny plan o nazwie Free Starter.",
        "Free Starter nie jest okresem próbnym ograniczonym czasowo. Nie wygasa po określonej liczbie dni.",
        "Użytkownicy mogą bezpłatnie korzystać z Solo .Bizz, dopóki mają maksymalnie 5 aktywnych klientów.",
        "Aktywny klient to rekord klienta, który nie został zarchiwizowany. Zarchiwizowani klienci nie są wliczani do limitu.",
        "Jeśli użytkownik Free Starter spróbuje utworzyć lub przywrócić klienta, co spowodowałoby przekroczenie limitu 5 aktywnych klientów, Solo .Bizz może wymagać przejścia na plan płatny.",
      ] },
      { h: "4. Plany subskrypcji i rozliczenia", body: [
        "Solo .Bizz oferuje następujące plany:",
        "**Free Starter**",
        ...
        "Cena miesięczna Solo Practice: 5 € miesięcznie.",
        "Dostępne także rozliczenia: 12 € kwartalnie lub 36 € rocznie.",
        ...
        "Cena miesięczna Pro Practice: 19 € miesięcznie.",
        "Dostępne także: 45,60 € kwartalnie lub 136,80 € rocznie.",
      ...
      { h: "5. Limity planów i wymagania dotyczące zmiany planu", body: [
        "Plany Solo .Bizz różnią się liczbą dostępnych aktywnych klientów.",
        "Aktualne limity: Free Starter — do 5 aktywnych klientów; Solo Practice — do 20; Pro Practice — bez limitu.",
        "Po osiągnięciu limitu planu Solo .Bizz może ograniczyć tworzenie lub przywracanie klientów do czasu zmiany planu lub zarchiwizowania klientów.",
      ...
      { h: "6. Metoda płatności i automatyczne odnowienie", body: [
        ...
        "Subskrybując plan płatny, upoważniasz Solo .Bizz lub dostawcę płatności do pobrania opłaty zgodnie z wybranym cyklem.",
      ] },
      { h: "7. Nieudane płatności", body: [
        ...
        "Jeśli płatność nie zostanie zrealizowana po wielu próbach, Solo .Bizz może zawiesić lub ograniczyć dostęp do funkcji planu płatnego.",
      ...
      { h: "10. Twoje dane", body: [
        "Pozostajesz właścicielem danych wprowadzonych do Solo .Bizz.",
        "Solo .Bizz nie sprzedaje Twoich danych.",
        ...
        "Korzystanie z Solo .Bizz podlega także Polityce prywatności.",
      ...
      { h: "11. Dozwolone użytkowanie", body: [
        "Zobowiązujesz się korzystać z Solo .Bizz wyłącznie do zgodnych z prawem celów zawodowych.",
        "Nie wolno:",
        [
          ...
          "używać Solo .Bizz do działań nielegalnych, szkodliwych lub nieautoryzowanych;",
      ...
      { h: "12. Dostępność usługi", body: [
        ...
        "Solo .Bizz może przeprowadzać prace konserwacyjne, aktualizacje lub ulepszenia. Gdy to możliwe, możemy informować o planowanych pracach.",
        "Solo .Bizz nie odpowiada za straty wynikłe z chwilowych przerw, problemów technicznych lub awarii dostawców zewnętrznych.",
      ] },
      { h: "13. Ograniczenie odpowiedzialności", body: [
        "Solo .Bizz jest dostarczany w stanie „takim, jaki jest” i „w miarę dostępności”.",
        "W maksymalnym zakresie dozwolonym przez prawo Solo .Bizz nie odpowiada za szkody pośrednie, przypadkowe, szczególne, wynikowe ani karne.",
        "Nasza całkowita odpowiedzialność jest ograniczona do kwoty zapłaconej Solo .Bizz w ciągu 12 miesięcy poprzedzających zdarzenie.",
      ...
      { h: "14. Zmiany planów, cen i regulaminu", body: [
        "Solo .Bizz może okresowo aktualizować plany, ceny, limity klientów, opcje rozliczeń lub niniejszy Regulamin.",
        ...
        "Dalsze korzystanie z Solo .Bizz po wejściu zmian w życie oznacza akceptację zaktualizowanego Regulaminu.",
      ] },
      { h: "15. Kontakt", body: [
  ...
  uk: {
    ...
    sections: [
      { h: "1. Прийняття умов", body: ["Створюючи обліковий запис або користуючись Solo .Bizz, ви погоджуєтесь з цими Умовами та положеннями. Якщо ви не згодні, не використовуйте сервіс."] },
      { h: "2. Опис сервісу", body: [
        "Solo .Bizz — це хмарний інструмент для керування діяльністю індивідуальних спеціалістів і невеликих приватних практик: психологів, терапевтів, коучів, репетиторів та інших постачальників послуг.",
        "Solo .Bizz надає функції керування клієнтами, планування сесій, обліку платежів, доходів і витрат, фінансової аналітики та організації практики.",
        "Solo .Bizz призначений для підтримки адміністрування та керування практикою. Фінансова аналітика має лише інформаційний характер і не є юридичною, податковою, бухгалтерською чи фінансовою порадою.",
      ] },
      { h: "3. Тариф Free Starter", body: [
        "Solo .Bizz пропонує постійний безкоштовний тариф Free Starter.",
        "Free Starter не є обмеженою в часі пробною версією. Він не закінчується через певну кількість днів.",
        "Користувачі можуть безкоштовно користуватися Solo .Bizz, доки мають до 5 активних клієнтів.",
        "Активний клієнт — це запис клієнта, який не заархівовано. Заархівовані клієнти не зараховуються до ліміту активних клієнтів.",
        "Якщо користувач Free Starter намагається створити або відновити клієнта, що перевищить ліміт у 5 активних клієнтів, Solo .Bizz може вимагати перехід на платний тариф.",
      ] },
      { h: "4. Тарифні плани та оплата", body: [
        "Solo .Bizz пропонує такі тарифи:",
        "**Free Starter**",
        ...
        "Місячна ціна Solo Practice: 5 € на місяць.",
        "Solo Practice також доступний: 12 € за квартал або 36 € на рік.",
        ...
        "Місячна ціна Pro Practice: 19 € на місяць.",
        "Pro Practice також доступний: 45,60 € за квартал або 136,80 € на рік.",
        "Квартальна оплата — знижка 20%, річна — 40% порівняно з помісячною оплатою.",
      ] },
      { h: "5. Ліміти тарифів і вимоги до оновлення", body: [
        "Тарифи Solo .Bizz відрізняються кількістю доступних активних клієнтів.",
        "Поточні ліміти: Free Starter — до 5 активних клієнтів; Solo Practice — до 20; Pro Practice — без обмежень.",
        "Після досягнення ліміту тарифу Solo .Bizz може обмежити створення або відновлення клієнтів до моменту оновлення тарифу або архівування клієнтів.",
      ...
      { h: "6. Спосіб оплати та автоматичне поновлення", body: [
        ...
        "Підписуючись на платний тариф, ви уповноважуєте Solo .Bizz або платіжного провайдера списувати відповідну плату згідно з обраним циклом.",
      ] },
      { h: "7. Невдалі платежі", body: [
        "У разі невдалого платежу ми або наш провайдер можемо повторити спробу списання.",
        "Якщо платіж не вдається після кількох спроб, Solo .Bizz може призупинити або обмежити доступ до можливостей платного тарифу до вирішення проблеми.",
      ...
      { h: "10. Ваші дані", body: [
        "Ви залишаєтесь власником даних, які вводите в Solo .Bizz.",
        "Solo .Bizz не продає ваші дані.",
        ...
        "Використання Solo .Bizz також регулюється нашою Політикою конфіденційності.",
      ...
      { h: "11. Допустиме використання", body: [
        "Ви погоджуєтесь використовувати Solo .Bizz лише в законних професійних і ділових цілях.",
        "Заборонено:",
        [
          ...
          "використовувати Solo .Bizz для незаконної, шкідливої чи неавторизованої діяльності;",
      ...
      { h: "12. Доступність сервісу", body: [
        ...
        "Solo .Bizz може проводити обслуговування, оновлення або покращення. За можливості ми повідомлятимемо про планові роботи.",
        "Solo .Bizz не несе відповідальності за збитки внаслідок тимчасових перебоїв, технічних проблем чи збоїв сторонніх провайдерів.",
      ] },
      { h: "13. Обмеження відповідальності", body: [
        "Solo .Bizz надається «як є» і «за наявності».",
        "У максимально дозволеному законом обсязі Solo .Bizz не несе відповідальності за непрямі, випадкові, спеціальні, наслідкові або штрафні збитки.",
        "Наша загальна відповідальність обмежується сумою, сплаченою Solo .Bizz протягом 12 місяців до події, що стала підставою для претензії.",
      ...
      { h: "14. Зміни тарифів, цін та умов", body: [
        "Solo .Bizz може час від часу оновлювати тарифи, ціни, ліміти клієнтів, варіанти оплати або ці Умови.",
        ...
        "Подальше використання Solo .Bizz після набрання змін чинності означає прийняття оновлених Умов.",
      ] },
      { h: "15. Контакт", body: [
