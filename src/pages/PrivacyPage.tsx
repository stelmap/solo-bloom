...
const CONTENT: Record<Language, PrivacyContent> = {
  en: {
    ...
    sections: [
      { h: "1. Introduction", body: [
        'Solo .Bizz ("we", "our", "us") is committed to protecting your privacy and personal data.',
        "This Privacy Policy explains how we collect, use, store, protect, and process personal information when you use Solo .Bizz.",
        "By using Solo .Bizz, you agree to the collection and use of information in accordance with this Privacy Policy.",
      ] },
      { h: "2. About Solo .Bizz", body: [
        "Solo .Bizz is a cloud-based business management tool for solo professionals and small private practices, including psychologists, therapists, coaches, tutors, consultants, and similar service providers.",
        "Solo .Bizz helps users manage clients, sessions, schedules, payments, income, expenses, and practice-related business information.",
      ] },
      ...
      { h: "4. Information We Collect", body: [
        ...
        "When you use Solo .Bizz, you may enter business-related data, including: client names and contact details; session dates, times, statuses, and notes; service types; payment statuses; income and expense records; invoices or payment-related information; practice organization data.",
        "This data belongs to you. You are responsible for ensuring that you have the right to enter, store, and process any client or business data you add to Solo .Bizz.",
        "**4.3 Sensitive or Confidential Data**",
        "Solo .Bizz is designed for practice and business management. Depending on how you use the service, you may choose to enter information related to clients, sessions, or professional services.",
        "You should avoid entering unnecessary sensitive information unless it is required for your lawful professional use.",
        "You are responsible for deciding what client information is appropriate to store in Solo .Bizz and for complying with any professional, confidentiality, data protection, or legal obligations that apply to your practice.",
        ...
        "We may collect usage data to understand how Solo .Bizz is used and to improve the product. This may include: pages or screens visited; features used; device and browser information; approximate usage timestamps; error logs; performance data; anonymized or aggregated analytics.",
      ...
      { h: "5. How We Use Your Information", body: [
        "We use your information to: create and manage your Solo .Bizz account; provide and maintain the Solo .Bizz service; manage clients, sessions, payments, and practice-related data inside your account; process subscriptions and billing; provide customer support; send important service, billing, security, or account-related notifications; improve product functionality and user experience; monitor system performance and fix technical issues; protect the security of the service; comply with applicable legal obligations.",
        "We do not sell your personal data.",
      ] },
      { h: "6. Legal Basis for Processing", body: [
        "Where applicable data protection laws require a legal basis for processing, we may process personal data based on one or more of the following grounds: performance of a contract with you; your consent; our legitimate interest in operating, securing, and improving Solo .Bizz; compliance with legal obligations; your instructions as a user of the service when processing business or client data that you enter into Solo .Bizz.",
        "For business and client data entered by users, the user may act as the data controller, and Solo .Bizz may act as a service provider or processor, depending on the applicable legal framework and use case.",
      ] },
      { h: "7. Data Ownership", body: [
        "You retain ownership of the business and client data you enter into Solo .Bizz.",
        "Solo .Bizz does not claim ownership over your client records, session data, financial records, or other business data.",
      ...
      { h: "9. Third-Party Services", body: [
        "We may use trusted third-party service providers to operate Solo .Bizz. These may include providers for: hosting and cloud infrastructure; authentication; payment processing; email delivery; analytics; customer support; system monitoring and error tracking.",
        "These providers may process personal data only as necessary to provide their services to Solo .Bizz and are expected to protect data according to applicable security and privacy standards.",
      ...
      { h: "10. Cookies and Similar Technologies", body: [
        ...
        "We may also use analytics technologies to understand product usage and improve Solo .Bizz.",
      ...
      { h: "11. Data Retention", body: [
        "We retain personal data only for as long as necessary to provide Solo .Bizz, comply with legal obligations, resolve disputes, enforce agreements, and maintain business records.",
      ...
      { h: "14. International Data Processing", body: [
        "Solo .Bizz may use cloud providers or service providers located in different countries.",
      ...
      { h: "15. Children's Privacy", body: [
        "Solo .Bizz is intended for professional and business use.",
        "Solo .Bizz is not intended for use by children. We do not knowingly collect personal data from children.",
      ...
      { h: "16. Automated Decision-Making", body: [
        "Solo .Bizz does not use personal data to make legally significant decisions about users based solely on automated processing.",
      ...
      { h: "17. Changes to This Privacy Policy", body: [
        ...
        "Continued use of Solo .Bizz after changes become effective means you accept the updated Privacy Policy.",
      ] },
      { h: "18. Contact", body: [
  ...
  fr: {
    ...
    sections: [
      { h: "1. Introduction", body: [
        'Solo .Bizz (« nous », « notre », « nos ») s\'engage à protéger votre vie privée et vos données personnelles.',
        "La présente Politique de confidentialité explique comment nous collectons, utilisons, stockons, protégeons et traitons les informations personnelles lorsque vous utilisez Solo .Bizz.",
        "En utilisant Solo .Bizz, vous acceptez la collecte et l'utilisation d'informations conformément à la présente Politique de confidentialité.",
      ] },
      { h: "2. À propos de Solo .Bizz", body: [
        "Solo .Bizz est un outil de gestion d'activité basé sur le cloud, destiné aux professionnels indépendants et aux petites pratiques privées, notamment psychologues, thérapeutes, coachs, tuteurs, consultants et prestataires de services similaires.",
        "Solo .Bizz aide les utilisateurs à gérer leurs clients, séances, plannings, paiements, revenus, dépenses et informations professionnelles liées à leur activité.",
      ] },
      ...
      { h: "4. Informations que nous collectons", body: [
        ...
        "Lorsque vous utilisez Solo .Bizz, vous pouvez saisir des données professionnelles, notamment : noms et coordonnées des clients ; dates, heures, statuts et notes des séances ; types de services ; statuts de paiement ; enregistrements de revenus et dépenses ; factures ou informations relatives aux paiements ; données d'organisation de l'activité.",
        "Ces données vous appartiennent. Vous êtes responsable de vous assurer que vous avez le droit de saisir, stocker et traiter toute donnée client ou professionnelle que vous ajoutez à Solo .Bizz.",
        "**4.3 Données sensibles ou confidentielles**",
        "Solo .Bizz est conçu pour la gestion de pratique et d'activité. Selon votre utilisation du service, vous pouvez choisir de saisir des informations relatives à des clients, des séances ou des services professionnels.",
        ...
        "Vous êtes responsable de décider quelles informations client sont appropriées à stocker dans Solo .Bizz et de respecter toute obligation professionnelle, de confidentialité, de protection des données ou légale applicable à votre pratique.",
        ...
        "Nous pouvons collecter des données d'utilisation pour comprendre comment Solo .Bizz est utilisé et améliorer le produit. Cela peut inclure : pages ou écrans visités ; fonctionnalités utilisées ; informations sur l'appareil et le navigateur ; horodatages approximatifs d'utilisation ; journaux d'erreurs ; données de performance ; analyses anonymisées ou agrégées.",
      ...
      { h: "5. Comment nous utilisons vos informations", body: [
        "Nous utilisons vos informations pour : créer et gérer votre compte Solo .Bizz ; fournir et maintenir le service Solo .Bizz ; gérer les clients, les séances, les paiements et les données professionnelles dans votre compte ; traiter les abonnements et la facturation ; fournir une assistance client ; envoyer des notifications importantes relatives au service, à la facturation, à la sécurité ou au compte ; améliorer les fonctionnalités et l'expérience utilisateur du produit ; surveiller les performances du système et corriger les problèmes techniques ; protéger la sécurité du service ; respecter les obligations légales applicables.",
        "Nous ne vendons pas vos données personnelles.",
      ] },
      { h: "6. Fondement juridique du traitement", body: [
        "Lorsque les lois applicables en matière de protection des données exigent un fondement juridique pour le traitement, nous pouvons traiter les données personnelles sur la base d'un ou plusieurs des motifs suivants : exécution d'un contrat avec vous ; votre consentement ; notre intérêt légitime à exploiter, sécuriser et améliorer Solo .Bizz ; respect des obligations légales ; vos instructions en tant qu'utilisateur du service lors du traitement des données professionnelles ou clients que vous saisissez dans Solo .Bizz.",
        "Pour les données professionnelles et clients saisies par les utilisateurs, l'utilisateur peut agir en tant que responsable du traitement, et Solo .Bizz peut agir en tant que prestataire de services ou sous-traitant, selon le cadre juridique applicable et le cas d'usage.",
      ] },
      { h: "7. Propriété des données", body: [
        "Vous conservez la propriété des données professionnelles et clients que vous saisissez dans Solo .Bizz.",
        "Solo .Bizz ne revendique pas la propriété de vos dossiers clients, données de séance, enregistrements financiers ou autres données professionnelles.",
      ...
      { h: "9. Services tiers", body: [
        "Nous pouvons utiliser des prestataires de services tiers de confiance pour exploiter Solo .Bizz. Ceux-ci peuvent inclure des prestataires pour : hébergement et infrastructure cloud ; authentification ; traitement des paiements ; envoi d'e-mails ; analyse ; assistance client ; surveillance des systèmes et suivi des erreurs.",
        "Ces prestataires peuvent traiter des données personnelles uniquement dans la mesure nécessaire pour fournir leurs services à Solo .Bizz et sont tenus de protéger les données conformément aux normes de sécurité et de confidentialité applicables.",
      ...
      { h: "10. Cookies et technologies similaires", body: [
        ...
        "Nous pouvons également utiliser des technologies d'analyse pour comprendre l'utilisation du produit et améliorer Solo .Bizz.",
      ...
      { h: "11. Conservation des données", body: [
        "Nous conservons les données personnelles uniquement aussi longtemps que nécessaire pour fournir Solo .Bizz, respecter les obligations légales, résoudre les litiges, faire respecter les accords et maintenir les registres commerciaux.",
      ...
      { h: "14. Traitement international des données", body: [
        "Solo .Bizz peut utiliser des fournisseurs cloud ou des prestataires de services situés dans différents pays.",
      ...
      { h: "15. Confidentialité des enfants", body: [
        "Solo .Bizz est destiné à un usage professionnel et commercial.",
        "Solo .Bizz n'est pas destiné à être utilisé par des enfants. Nous ne collectons pas sciemment de données personnelles auprès d'enfants.",
      ...
      { h: "16. Prise de décision automatisée", body: [
        "Solo .Bizz n'utilise pas de données personnelles pour prendre des décisions juridiquement significatives concernant les utilisateurs sur la base d'un traitement entièrement automatisé.",
      ...
      { h: "17. Modifications de la présente Politique de confidentialité", body: [
        ...
        "L'utilisation continue de Solo .Bizz après l'entrée en vigueur des modifications signifie que vous acceptez la Politique de confidentialité mise à jour.",
      ] },
      { h: "18. Contact", body: [
  ...
  pl: {
    ...
    sections: [
      { h: "1. Wprowadzenie", body: [
        'Solo .Bizz ("my", "nasz", "nas") zobowiązuje się do ochrony Twojej prywatności i danych osobowych.',
        "Niniejsza Polityka prywatności wyjaśnia, w jaki sposób zbieramy, wykorzystujemy, przechowujemy, chronimy i przetwarzamy dane osobowe podczas korzystania z Solo .Bizz.",
        "Korzystając z Solo .Bizz, zgadzasz się na zbieranie i wykorzystywanie informacji zgodnie z niniejszą Polityką prywatności.",
      ] },
      { h: "2. O Solo .Bizz", body: [
        "Solo .Bizz to oparte na chmurze narzędzie do zarządzania działalnością dla samozatrudnionych profesjonalistów i małych praktyk prywatnych, w tym psychologów, terapeutów, coachów, korepetytorów, konsultantów i podobnych dostawców usług.",
        "Solo .Bizz pomaga użytkownikom zarządzać klientami, sesjami, harmonogramami, płatnościami, przychodami, wydatkami oraz informacjami biznesowymi związanymi z praktyką.",
      ] },
      ...
      { h: "4. Informacje, które zbieramy", body: [
        ...
        "Podczas korzystania z Solo .Bizz możesz wprowadzać dane biznesowe, w tym: imiona i nazwiska klientów oraz dane kontaktowe; daty, godziny, statusy i notatki dotyczące sesji; rodzaje usług; statusy płatności; zapisy przychodów i wydatków; faktury lub informacje związane z płatnościami; dane organizacyjne praktyki.",
        "Te dane należą do Ciebie. Jesteś odpowiedzialny za zapewnienie, że masz prawo do wprowadzania, przechowywania i przetwarzania wszelkich danych klientów lub biznesowych, które dodajesz do Solo .Bizz.",
        "**4.3 Dane wrażliwe lub poufne**",
        "Solo .Bizz jest przeznaczony do zarządzania praktyką i działalnością. W zależności od sposobu korzystania z usługi, możesz zdecydować się na wprowadzenie informacji związanych z klientami, sesjami lub usługami zawodowymi.",
        ...
        "Jesteś odpowiedzialny za decydowanie, jakie informacje o klientach są odpowiednie do przechowywania w Solo .Bizz oraz za przestrzeganie wszelkich zawodowych, poufnościowych, ochrony danych lub prawnych obowiązków dotyczących Twojej praktyki.",
      ...
      { h: "5. Jak wykorzystujemy Twoje informacje", body: [
        "Wykorzystujemy Twoje informacje do: tworzenia i zarządzania Twoim kontem Solo .Bizz; świadczenia i utrzymania usługi Solo .Bizz; zarządzania klientami, sesjami, płatnościami i danymi związanymi z praktyką w Twoim koncie; przetwarzania subskrypcji i rozliczeń; świadczenia wsparcia klienta; wysyłania ważnych powiadomień dotyczących usługi, rozliczeń, bezpieczeństwa lub konta; ulepszania funkcjonalności produktu i doświadczenia użytkownika; monitorowania wydajności systemu i naprawiania problemów technicznych; ochrony bezpieczeństwa usługi; zgodności z obowiązującymi przepisami prawnymi.",
        "Nie sprzedajemy Twoich danych osobowych.",
      ] },
      { h: "6. Podstawa prawna przetwarzania", body: [
        "Tam, gdzie obowiązujące przepisy o ochronie danych wymagają podstawy prawnej do przetwarzania, możemy przetwarzać dane osobowe na podstawie jednego lub więcej z następujących gruntów: wykonanie umowy z Tobą; Twoja zgoda; nasz uzasadniony interes w zakresie działania, zabezpieczenia i ulepszania Solo .Bizz; zgodność z obowiązkami prawnymi; Twoje instrukcje jako użytkownika usługi podczas przetwarzania danych biznesowych lub klientów, które wprowadzasz do Solo .Bizz.",
        "W przypadku danych biznesowych i klientów wprowadzanych przez użytkowników, użytkownik może działać jako administrator danych, a Solo .Bizz może działać jako dostawca usług lub podmiot przetwarzający, w zależności od obowiązującego ramy prawnej i przypadku użycia.",
      ] },
      { h: "7. Własność danych", body: [
        "Zachowujesz własność danych biznesowych i klientów, które wprowadzasz do Solo .Bizz.",
        "Solo .Bizz nie rości sobie prawa własności do Twoich zapisów klientów, danych o sesjach, zapisów finansowych ani innych danych biznesowych.",
      ...
      { h: "9. Usługi stron trzecich", body: [
        "Możemy korzystać z zaufanych dostawców usług stron trzecich do obsługi Solo .Bizz. Mogą to być dostawcy: hostingu i infrastruktury chmurowej; uwierzytelniania; przetwarzania płatności; dostarczania e-maili; analityki; wsparcia klienta; monitorowania systemów i śledzenia błędów.",
        "Ci dostawcy mogą przetwarzać dane osobowe tylko w zakresie niezbędnym do świadczenia swoich usług dla Solo .Bizz i powinni chronić dane zgodnie z obowiązującymi standardami bezpieczeństwa i prywatności.",
      ...
      { h: "10. Pliki cookie i podobne technologie", body: [
        ...
        "Możemy również używać technologii analitycznych do zrozumienia użytkowania produktu i ulepszania Solo .Bizz.",
      ...
      { h: "11. Retencja danych", body: [
        "Przechowujemy dane osobowe tylko tak długo, jak jest to konieczne do świadczenia Solo .Bizz, zgodności z obowiązkami prawnymi, rozwiązywania sporów, egzekwowania umów i prowadzenia rejestrów biznesowych.",
      ...
      { h: "14. Międzynarodowe przetwarzanie danych", body: [
        "Solo .Bizz może korzystać z dostawców chmury lub usługodawców zlokalizowanych w różnych krajach.",
      ...
      { h: "15. Prywatność dzieci", body: [
        "Solo .Bizz jest przeznaczony do użytku zawodowego i biznesowego.",
        "Solo .Bizz nie jest przeznaczony do użytku przez dzieci. Nie zbieramy świadomie danych osobowych od dzieci.",
      ...
      { h: "16. Automatyczne podejmowanie decyzji", body: [
        "Solo .Bizz nie wykorzystuje danych osobowych do podejmowania decyzji o znaczeniu prawnym dotyczących użytkowników wyłącznie na podstawie zautomatyzowanego przetwarzania.",
      ...
      { h: "17. Zmiany w niniejszej Polityce prywatności", body: [
        ...
        "Kontynuowanie korzystania z Solo .Bizz po wejściu w życie zmian oznacza akceptację zaktualizowanej Polityki prywatności.",
      ] },
      { h: "18. Kontakt", body: [
  ...
  uk: {
    ...
    sections: [
      { h: "1. Вступ", body: [
        'Solo .Bizz («ми», «наш», «нас») прагне захищати вашу конфіденційність і персональні дані.',
        "Ця Політика конфіденційності пояснює, як ми збираємо, використовуємо, зберігаємо, захищаємо та обробляємо персональну інформацію під час використання Solo .Bizz.",
        "Використовуючи Solo .Bizz, ви погоджуєтесь на збір та використання інформації відповідно до цієї Політики конфіденційності.",
      ] },
      { h: "2. Про Solo .Bizz", body: [
        "Solo .Bizz — це хмарний інструмент для управління бізнесом для самозайнятих професіоналів та малих приватних практик, зокрема психологів, терапевтів, коучів, репетиторів, консультантів та подібних постачальників послуг.",
        "Solo .Bizz допомагає користувачам керувати клієнтами, сеансами, розкладами, платежами, доходами, витратами та бізнес-інформацією, пов'язаною з практикою.",
      ] },
      ...
      { h: "4. Інформація, яку ми збираємо", body: [
        ...
        "Використовуючи Solo .Bizz, ви можете вводити бізнес-дані, зокрема: імена та контактні дані клієнтів; дати, час, статуси та нотатки сеансів; типи послуг; статуси платежів; записи доходів та витрат; рахунки-фактури або інформацію, пов'язану з платежами; організаційні дані практики.",
        "Ці дані належать вам. Ви несете відповідальність за те, щоб мати право вводити, зберігати та обробляти будь-які дані клієнтів або бізнес-дані, які ви додаєте до Solo .Bizz.",
        "**4.3 Чутливі або конфіденційні дані**",
        "Solo .Bizz призначений для управління практикою та бізнесом. Залежно від того, як ви використовуєте сервіс, ви можете вибрати введення інформації, пов'язаної з клієнтами, сеансами або професійними послугами.",
        ...
        "Ви несете відповідальність за вирішення, яка інформація про клієнтів доречна для зберігання в Solo .Bizz, та за дотримання будь-яких професійних, конфіденційних, захисту даних або юридичних зобов'язань, що застосовуються до вашої практики.",
        ...
        "Ми можемо збирати дані про використання, щоб зрозуміти, як використовується Solo .Bizz, та покращити продукт. Це може включати: відвідувані сторінки або екрани; використовувані функції; інформацію про пристрій і браузер; приблизні часові позначки використання; журнали помилок; дані про продуктивність; анонімізовану або агреговану аналітику.",
      ...
      { h: "9. Сторонні сервіси", body: [
        "Ми можемо використовувати надійних сторонніх постачальників послуг для роботи Solo .Bizz. Це можуть бути постачальники: хостингу та хмарної інфраструктури; автентифікації; обробки платежів; доставки електронної пошти; аналітики; підтримки клієнтів; моніторингу систем та відстеження помилок.",
        "Ці постачальники можуть обробляти персональні дані лише в обсязі, необхідному для надання своїх послуг для Solo .Bizz, і повинні захищати дані відповідно до застосовних стандартів безпеки та конфіденційності.",
      ...
      { h: "10. Файли cookie та подібні технології", body: [
        ...
        "Ми також можемо використовувати аналітичні технології для розуміння використання продукту та покращення Solo .Bizz.",
      ...
      { h: "11. Зберігання даних", body: [
        "Ми зберігаємо персональні дані лише стільки, скільки це необхідно для надання Solo .Bizz, дотримання юридичних зобов'язань, вирішення спорів, виконання угод та ведення бізнес-записів.",
      ...
      { h: "14. Міжнародна обробка даних", body: [
        "Solo .Bizz може використовувати хмарних провайдерів або постачальників послуг, розташованих у різних країнах.",
      ...
      { h: "15. Конфіденційність дітей", body: [
        "Solo .Bizz призначений для професійного та бізнес-використання.",
        "Solo .Bizz не призначений для використання дітьми. Ми свідомо не збираємо персональні дані від дітей.",
      ...
      { h: "16. Автоматизоване прийняття рішень", body: [
        "Solo .Bizz не використовує персональні дані для прийняття юридично значущих рішень щодо користувачів виключно на основі автоматизованої обробки.",
      ...
      { h: "17. Зміни до цієї Політики конфіденційності", body: [
        ...
        "Продовження використання Solo .Bizz після набрання чинності змін означає, що ви приймаєте оновлену Політику конфіденційності.",
      ] },
      { h: "18. Контакт", body: [
